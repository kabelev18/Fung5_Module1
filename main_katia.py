...
Patient.instantiate_from_csv("C:\\Users\\kabel\\OneDrive\\Desktop\\Comp BME\\Mod 1\\Fung5_Module1\\Metadata and Protein Data for Module 1.csv")
...
# making a scatter plot of years of education vs. age at death
education = []
age_at_death = []

for patient in Patient.all_patients:
    education.append(patient.years_of_ed)
    age_at_death.append(patient.age_at_death)

plt.scatter(education, age_at_death, color='blue')
